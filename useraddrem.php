...
<button class="btn btn-success badge-pill btn-lg" name="adduserbutton" id="adduserbutton" onClick="location.href='adduser.php' "><b>Add User</b></button>
