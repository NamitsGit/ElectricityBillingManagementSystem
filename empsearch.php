...
<table class="box">
    ...
    if($_SERVER['REQUEST_METHOD']=="POST"){
      $empnamesearch=$_POST['empnamesearch'];
      $sql="SELECT * FROM employee WHERE empname LIKE '%$empnamesearch%' ";
...
<button class="btn btn-success badge-pill btn-lg" name="addempbutton" id="addempbutton" onClick="location.href='addreader.php' "><b>Add Employee</b></button>
