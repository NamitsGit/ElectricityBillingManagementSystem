...
<?php
  ...
  if($_SERVER['REQUEST_METHOD']=="POST"){
      $searchstring=$_POST['usernamesearch'];
  ...
  if($num>0){
    ...
    <strong>'.$num.' </strong> User(s) found!
    <button type="button" class="btn-close" data-bs-dismiss="alert" aria-label="Close"></button>
    </div>';
    
    
      while($row=mysqli_fetch_assoc($result)){
          echo '<tr><td>'.$row['userid'].'</td><td>'.$row['username'].'</td><td>'.$row['useremail'].'</td><td>'.$row['userphone'].'</td><td>'.$row['useraddress'].'</td><td><form action="remuser.php" method="POST"><input type="hidden" value="'.$row['userid'].'" name="curruserid" id="curruserid"><button type="submit" class="btn btn-danger badge-pill">Remove</button></form></td></tr>';
      }
      echo "</table>";
  }
  else if($num==0){
...
?>
<div class="newbox">
    <form class="d-flex" action="usersearch.php" method="post">
      <input class="form-control me-2" id="usernamesearch" name="usernamesearch" type="search" placeholder="Search a user by name" aria-label="Search" required>
      <button class="btn btn-success" name="searchbutton" id="searchbutton" type="submit">Search</button>
    </form>
</div>
<button class="btn btn-primary badge-pill btn-lg" name="adduserbutton" id="adduserbutton" onClick="location.href='adduser.php' "><b>Add User</b></button>
